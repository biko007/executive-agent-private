/**
 * assets/store — JSON-based persistence for Properties, Units, Leases, NK.
 * Migration to Postgres planned for Sprint 5.
 */
import fs from 'fs';
import path from 'path';
import type {
  Property, PropertyType, OwnerEntity, Unit, DistributionKey,
