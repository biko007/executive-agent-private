/**
 * fleet/store — JSON-based vehicle persistence.
 * Migration to Postgres planned for Sprint 6.
 */
import fs from 'fs';
import path from 'path';
import { updateEntityId } from '../../shared/links/index.js';
import type {
  Vehicle, VehicleType, VehicleDocument, Insurance, ServiceEntry,
  DeadlineWarning,
} from './types.js';
